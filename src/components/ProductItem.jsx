  ...
  return (
    <div className={styles.ProductItem}>
      ...
      <div className={styles['product-info']}>
        ...
        <switch className={styles['more-clickable-area']} onClick={() => handleClick(product)} onKeyDown={() => handleClick(product)}>
...
/*<switch onClick={() => handleClick(product)} onKeyDown={() => handleClick(product)}> */
